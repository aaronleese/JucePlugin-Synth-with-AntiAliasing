...
*/
class WaveGenPluginAudioProcessor  : public AudioProcessor
{
public:
    
    // OUTPUT ::: for display
    AudioSampleBuffer currentOutput;
    
    //==============================================================================
    WaveGenPluginAudioProcessor();
    ~WaveGenPluginAudioProcessor();
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (WaveGenPluginAudioProcessor)
};
